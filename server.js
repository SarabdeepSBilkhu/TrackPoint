...
app.post('/api/chat', authenticate, async (req, res) => {
    try {
        ...
        const response = await axios.post(
            'https://api.groq.com/openai/v1/chat/completions',
            {
                ...
                messages: [
                    {
                        role: "system",
                        content: "You are an assistant for a Real-Time Vehicle Tracking System. Help users with vehicle tracking, system usage, and general queries."
                    },
        ...
        res.status(500).json({
            reply: "Sorry, chatbot is currently unavailable."
        });
    }
});
